...
/*
  ...
  выбор пережил переходы между страницами. Сохраняем только идентификаторы;
  страница сравнения загружает актуальные цены, наличие и характеристики.
*/
...
export const useCompare = create<CompareState>()(
  persist(
    ...
    {
      name: "momo-compare",
      partialize: (s) => ({ items: s.items.map((p) => ({ slug: p.slug }) as Product) }),
    },
  ),
);
