...
/*
  ...
  Конвейер: обрезать однотонные поля по краям (trim), вписать в 1600×1600 и
  сжать в webp качеством 88. Крупный размер — ради чёткого увеличения в
  галерее: лайтбокс показывает исходный файл до 1600px, при 900px он мылил.
  На плитки каталога Next всё равно отдаёт мелкие варианты по `sizes`, так
  что скорость списка от этого не страдает — крупный файл грузится только
  когда покупатель открыл фото на весь экран.
*/
