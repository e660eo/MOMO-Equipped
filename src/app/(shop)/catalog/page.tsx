...
export const metadata: Metadata = {
  title: "Каталог",
  description: `Каталог автоакустики MOMO: сабвуферы, усилители, динамики, мультимедиа, автосвет и аксессуары. ${productCount} ${plural(productCount, "товар", "товара", "товаров")} с фильтрами по категориям и брендам.`,
