      ...
      <section className="mt-12">
        ...
        <div className="mt-5 grid gap-4 sm:grid-cols-2">
          ...
          <div className="rounded-xl border border-border bg-surface p-6">
            ...
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
              Отправляем через Ozon (Ozon доставка) — до пункта выдачи или до
              двери. Сроки и стоимость — по тарифам Ozon, согласуем при
        ...
        <div className="mt-4 rounded-xl border border-border bg-surface p-6">
          <p className="text-sm leading-relaxed">
            ...
            <span className="text-muted-foreground">
              Для заказов меньшей суммы доставка — по тарифам Ozon: они зависят
              от региона и габаритов, менеджер называет точную сумму до оплаты.
              Срок в пути зависит от адреса — ориентир по вашему городу менеджер
              сообщает при подтверждении заказа.
            </span>
          </p>
        </div>
      </section>
