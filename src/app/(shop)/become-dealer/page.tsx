  ...
  return <main>
    <section className="border-b border-border bg-[#111113] text-white">
      <div className="mx-auto grid max-w-[1180px] gap-10 px-4 py-14 sm:px-6 sm:py-20 lg:grid-cols-[1.05fr_.75fr] lg:items-end">
        <div><p className="font-mono text-xs uppercase tracking-[0.22em] text-[#ff7a33]">Партнёрская программа MOMO / ZEUS</p><h1 className="mt-5 max-w-[16ch] break-normal text-balance font-display text-[clamp(2rem,4.6vw,4rem)] font-black uppercase leading-[0.94]">Продавайте автозвук <span className="text-signal"><span className="lg:whitespace-nowrap">с поддержкой</span> бренда</span></h1><p className="mt-6 max-w-[58ch] text-base leading-relaxed text-white/65 sm:text-lg">Для магазинов, установочных студий и интернет-площадок. После одобрения вы получите закрытые условия, персональные цены, остатки и материалы в дилерском кабинете.</p></div>
