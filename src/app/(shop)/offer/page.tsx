  ...
  return (
    <main className="mx-auto max-w-[840px] px-6 py-14">
      ...
      <Section n="04" title="Оформление заказа">
        <p>
          Покупатель формирует Заказ в корзине Сайта. Заказ передаётся менеджеру
          Продавца (в том числе через WhatsApp), который подтверждает наличие,
          состав и итоговую сумму с учётом доставки в течение {processing}.
        </p>
        <p>
          Договор считается заключённым с момента подтверждения Заказа менеджером
          и согласования Покупателем итоговой суммы. Оформляя Заказ, Покупатель
      ...
      <Section n="05" title="Цена и оплата">
        <p>
          Цены на Товар указаны на Сайте в рублях РФ. Итоговая сумма Заказа с
          учётом доставки фиксируется при подтверждении Заказа и до оплаты.
        </p>
        <List
          items={[
            "оплата производится после подтверждения Заказа способами, которые Продавец сообщает при согласовании, в том числе по банковским реквизитам, указанным ниже;",
            "сплит (4 платежа без процентов) оформляется через менеджера при подтверждении Заказа;",
            "онлайн-оплата банковской картой на Сайте подключается и станет доступна в ближайших обновлениях.",
          ]}
        />
      </Section>
      ...
      <Section n="06" title="Доставка и получение">
        ...
        <List
          items={[
            ...
            <>
              <b>Доставка по России — через сервис Ozon (Ozon доставка)</b> до
              пункта выдачи или до двери. Сроки и стоимость доставки определяются
              условиями и тарифами службы Ozon и зависят от региона и габаритов
              Товара; ориентировочный срок и точную сумму Продавец сообщает
        ...
        <p>
          ...
          бесплатно. Право собственности и риск случайной гибели Товара переходят
