  ...
  return (
    <main className="mx-auto max-w-[840px] px-6 py-14">
      ...
      <Section n="08" title="Гарантия">
        <p>
          Стандартная гарантия на оборудование составляет <b>{trust.warrantyMonths} месяцев</b>{" "}
          с момента получения Товара. При установке оборудования в авторизованном
          центре MOMO/ZEUS гарантия составляет <b>{trust.extendedWarrantyMonths} месяца</b>.
          Если иной срок указан в карточке Товара или гарантийном талоне производителя,
          применяется указанный там срок.
        </p>
      </Section>
