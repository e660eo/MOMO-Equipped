    ...
    <main className="overflow-x-hidden">
      ...
      <section className="border-b border-border">
        <div className="relative overflow-hidden bg-white text-zinc-900">
          {/* ReactBits Strands: объёмная звуковая линия в палитре MOMO */}
          <HeroBackdrop />
          {/* мягкое высветление за текстом для читаемости */}
          <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_52%_48%_at_50%_44%,rgba(255,255,255,0.28),rgba(255,255,255,0.08)_62%,transparent_84%)]" />
